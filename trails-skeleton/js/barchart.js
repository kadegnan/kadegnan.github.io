class Barchart {
  ...
  renderVis() {
    ...
    //   .attr('fill', d => vis.config.colorScale(vis.colorValue(d))) // use color accesor function
    ...
    const bars = vis.chart.selectAll('.bar')
      ...
      .attr('width', vis.xScale.bandwidth())
      .attr('height', d => vis.height - vis.yScale(vis.yValue(d)))
      .attr('fill', d => vis.config.colorScale(vis.colorValue(d))) // use color accesor functio
      .on('click', function (event, d) {
